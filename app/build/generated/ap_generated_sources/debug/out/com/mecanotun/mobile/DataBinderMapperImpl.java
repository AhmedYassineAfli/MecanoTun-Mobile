...
import com.mecanotun.mobile.databinding.ActivityTimeSlotSelectionBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYTIMESLOTSELECTION = 7;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mecanotun.mobile.R.layout.activity_time_slot_selection, LAYOUT_ACTIVITYTIMESLOTSELECTION);
  }
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_ACTIVITYTIMESLOTSELECTION: {
          if ("layout/activity_time_slot_selection_0".equals(tag)) {
            return new ActivityTimeSlotSelectionBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for activity_time_slot_selection is invalid. Received: " + tag);
        }
      }
    }
    return null;
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/activity_time_slot_selection_0", com.mecanotun.mobile.R.layout.activity_time_slot_selection);
    }
  }
}
