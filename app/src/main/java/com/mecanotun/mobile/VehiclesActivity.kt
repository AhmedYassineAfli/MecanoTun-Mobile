...
class VehiclesActivity : AppCompatActivity() {
    ...
    private fun loadVehicles() {
        ...
        lifecycleScope.launch {
            try {
                val response = RetrofitClient.instance.getCarsByCustomer(customerId)
    ...
    private fun addVehicle(brand: String, model: String, engine: String, vin: String?, year: Int?) {
        ...
        lifecycleScope.launch {
            try {
                val response =
                        RetrofitClient.instance.createCar(
                                customerId,
                                brand,
                                model,
                                engine,
    ...
    private fun updateVehicle(
        ...
        lifecycleScope.launch {
            try {
                val response =
                        RetrofitClient.instance.updateCar(carId, brand, model, engine, vin, year)
    ...
    private fun deleteVehicle(carId: Int) {
        lifecycleScope.launch {
            try {
                val response = RetrofitClient.instance.deleteCar(carId)
