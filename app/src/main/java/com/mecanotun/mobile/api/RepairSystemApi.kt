...
interface RepairSystemApi {
        ...
        @GET("mechanic/{id}")
        suspend fun getMechanicById(@Path("id") id: Int): Response<MechanicDto>
        ...
        @GET("timeslot") suspend fun getAllTimeSlots(): Response<List<TimeSlotDto>>

        @GET("timeslot/available") suspend fun getAvailableTimeSlots(): Response<List<TimeSlotDto>>
}
